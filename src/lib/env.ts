...
export interface Env {
  SPACEEXPLORER_API_KEY_AUTH?: string | undefined;

  SPACEEXPLORER_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodType<Env, z.ZodTypeDef, unknown> = z.object({
  SPACEEXPLORER_API_KEY_AUTH: z.string(),

  SPACEEXPLORER_DEBUG: z.coerce.boolean(),
})
  .partial();
